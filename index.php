            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link" href="#">
                  ...
                  <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=disk_util.sda&alarm=10min_disk_utilization&refresh=auto" type="image/svg+xml" height="20"/>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <span data-feather="file-text"></span>
                  <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=system.cpu&alarm=10min_cpu_usage&refresh=auto" type="image/svg+xml" height="20"/>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <span data-feather="file-text"></span>
                  <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=system.ram&alarm=ram_in_use&refresh=auto" type="image/svg+xml" height="20"/>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <span data-feather="file-text"></span>
                  <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=disk_space._&alarm=disk_space_usage&refresh=auto" type="image/svg+xml" height="20"/>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">
                  <span data-feather="file-text"></span>
                  <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=mysql_local.queries&alarm=mysql_10s_slow_queries&refresh=auto" type="image/svg+xml" height="20"/>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list" aria-selected="true">
            ...
            <div class="col-sm">
              <div class="netdata-container-gauge"
                   ...
                   data-dimensions="" data-height="270"
                   data-width="100%" data-chart-library="gauge"
                   data-gauge-adjust="width"
                   data-title="Nginx Connections"
                   data-before="0" data-after="-480"
            ...
            <div class="col-sm">
              <div class="netdata-container-gauge" 
              data-netdata="nginx_local.requests" 
              data-dimensions=""  
              data-height="270" 
              data-width="100%" 
              data-chart-library="gauge" 
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="bg-white"><div data-netdata="system.cpu"
                  ...
                  ></div> </td>
                  <td class="bg-white">
                      <div data-netdata="mem.available"
                           data-chart-library="dygraph"
                           data-dygraph-theme="sparkline"
                           data-width="100%"
                           data-height="200px"
